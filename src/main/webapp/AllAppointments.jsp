	...
	<table>
		...
		<tr>
			...
			try {
				...
				"select a.appointmentId,a.dateAndTime, a.department, d.name AS doctor_name,  p.name AS patient_name,a.payment, a.status from appointment a JOIN patient p ON a.patientId = p.patientId JOIN doctor d ON a.doctorId = d.doctorId");
				// Execute the query
			...
			<td>
				<%
				if ("booked".equals(status)) { // Use .equals to compare strings in Java
				%>
